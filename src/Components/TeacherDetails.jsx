    ...
    <div className='conatiner mt-4 px-4'class='hod'>
        <div className='row'>
            ...
            <div className='col-8'>
                ...
                <p className='fw-bold'>Cursos totales : {teacherData.total_teacher_course}</p>
                <p className='fw-bold'>Contactar al profesor : {teacherData.email}</p>
                <p className='fw-bold'>Calificaciones: {teacherData.qualification}</p>
                <p className='fw-bold '> Sígueme : <br/>
