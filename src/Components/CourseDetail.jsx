    ...
    <div className='conatiner mt-4 px-4 hod'>
        ...
        <div class="col-lg-3 col-md-6 mt-3">
            ...
            <div className='col-8 pd-2 mt-3'>
                ...
                <p className='fw-bold'>Curso por:<Link to={`/teacher-detail/${teacherData.id}`}>{teacherData.full_name}</Link></p>
                <p className='fw-bold'>Técnicas:&nbsp;
                  <a className='text-warning'>{courseData.techs}</a>
                </p>
                <p className='fw-bold'>Total matriculados &nbsp;<i class="bi bi-person-plus-fill text-info"></i> :&nbsp;{courseData.total_enrolled_students}</p>
                <p className='fw-bold'>
                Rating : {avgRating} / 5
                {enrolledStatus=='success' && userLoginStatus=='success' &&
                <>
                {ratingStatus != 'success' &&
                  <button className='btn btn-success btn-sm ms-2' data-bs-toggle="modal" data-bs-target="#ratingModal">Clasificación</button>
                }
                {ratingStatus == 'success' &&
                        ...
                        <div className="modal-dialog modal-lg">
                          <div className="modal-content">
                            ...
                            <div className="modal-body">
                                ...
                                <button onClick={formSubmit} type="submit" class="btn btn-primary">Entregar</button>
                ...
                {userLoginStatus == 'success' && enrolledStatus!=='success' &&
                    <p><button type='button' className='btn btn-success rounded-pill ' onClick={enrollCourse} >Inscríbete en este curso</button></p>
                }
                {enrolledStatus=='success' && userLoginStatus=='success' &&
                    <p><span className='btn btn-info rounded-pill btn-sm'>Ya estas matriculado en este curso</span></p>
                }
                ...
                {userLoginStatus !== 'success' &&
                    <p><Link to='/user-login' className='btn btn-danger rounded-pill'>Por favor inicia sesión para disfrutar de este curso</Link></p>
                }
            </div>
        </div>
        {/* Course Videos*/}
      ...
      <>
        ...
        <Link to={`/mini/${courseData.id}`} className='btn btn-sm bg-success mt-2 text-white'>Empezar ahora</Link>
      </>
      }
