                ...
                <div className='row mt-3'>
                  ...
                  <div className='col-md-4 pt-3'>
                    <div className='card border-primary'>
                      <h5 className='card-header bg-warning text-white'>Cursos matriculados</h5>
                  ...
                  <div className='col-md-4 pt-3'>
                    <div className='card border-primary'>
                      <h5 className='card-header bg-success text-white'>Cursos favoritos</h5>
                      <div className='card-body'>
                  ...
                  <div className='col-md-4 pt-3'>
                    <div className='card border-primary'>
                      <h5 className='card-header bg-info text-white'>Tarea completada</h5>
                      <div className='card-body'>
                  ...
                  <div className='col-md-4 pt-3'>
                    <div className='card border-primary'>
                      <h5 className='card-header bg-danger text-white'>Asignación pendiente</h5>
                      <div className='card-body'>
